...
import { addProductsToCart, getCartDetails, removeProductsFromCart } from "../../Redux/Slice/cartSlice";
...
const[isInCart,setisInCart]=useState(false);  
 async function fetchProductDetails(){
   ...
   setProductDetails(details?.payload?.data?.data?.response);
return details;
}
 useEffect(()=>{
fetchProductDetails()
...
async function handleCart(){
    const response =await dispatch(addProductsToCart(productId));
    console.log("This is cart Response->",response);
...
async function handleRemove(productId) {
    ...
    const response = await dispatch(removeProductsFromCart(productId));
    if(response?.payload?.data?.success) {
        setisInCart(false);
